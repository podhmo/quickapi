...
func TestLift_OK(t *testing.T) {
	...
	got := quickapitest.DoHandler[[]int](t, handler, req, 200)
	want := []int{1, 2, 3}
...
func TestLift_OK_WithDefault(t *testing.T) {
	...
	got := quickapitest.DoHandler[person](t, handler, req, 200)
...
func TestLift_NotFound(t *testing.T) {
	...
	got := quickapitest.DoHandler[quickapi.ErrorResponse](t, handler, req, code)
...
func TestLift_BindPathVars(t *testing.T) {
	...
	t.Run("200", func(t *testing.T) {
		...
		got := quickapitest.DoHandler[Output](t, r, req, 200)
	...
	t.Run("404", func(t *testing.T) {
		...
		quickapitest.DoHandler[quickapi.ErrorResponse](t, r, req, 404)
	})
}
...
func TestLift_BindData(t *testing.T) {
	...
	t.Run("200", func(t *testing.T) {
		...
		got := quickapitest.DoHandler[Output](t, h, req, 200)
